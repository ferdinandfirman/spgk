  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="container">
      <a href="index.html" class="brand-link">
        <img src="/storage/logo/Logo BPK Penabur.png" width="32px" alt="BPK Penabur Logo">
        <span class="brand-text" style="font-size:18px">Sistem Penggajian<br>Guru dan Karyawan</span>
      </a>
    </div>
